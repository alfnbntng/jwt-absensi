...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (role.contains(new SimpleGrantedAuthority("ROLE_RW"))) {
            claims.put("isRw", true);
        }
    ...
    public List<SimpleGrantedAuthority> getRolesFromToken(String token) {
        ...
        Boolean isRw = claims.get("isRw", Boolean.class);
        ...
        if (isRw != null && isAdmin) {
            roles = Arrays.asList(new SimpleGrantedAuthority("ROLE_RW"));
        }
